...
if(isset($_POST['submit'])) 
  {
    ...
    $query =$dbh->prepare("SELECT ID FROM teacher WHERE Email=:emailid and MobileNumber=:phoneno");
...
$sql="insert into teacher(Name,Email,MobileNumber,password)values(:fname,:emailid,:phoneno,:password)";
