...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID,Name FROM teacher WHERE (Email=:username || MobileNumber=:username) and password=:password";
...
<body class="bg-dark" style=" background-image: url('images/background.jpg');">
