            ...
            <header class="bg-dark py-5">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="images/image1.jpg" alt="..." /></div>
                    </div>
                </div>
            </header>
...
<hr color="red" />
                    ...
                    <div class="row gx-5">
                                    <?php
$sql="SELECT * from teacher where isPublic='1' limit 9";
