...
$teacherid=$_GET['tid'];
$sql="insert into query(teacherId,fName,emailId,mobileNumber,Query)values(:teacherid,:fname,:emailid,:mobileno,:querymsg)";
...
<?php
$tid=intval($_GET['tid']);
$sql="SELECT * from teacher where isPublic='1' and ID='$tid'";
$query = $dbh -> prepare($sql);
$query->execute();
